...
// Shared between Project Charter and Persona Builder.
// ============================================================
...
let _deIdReturnTo   = 'welcome'; // 'welcome' or 'builder' — where Back button goes
 ...
 * @param {string} [returnTo] - 'welcome' (default) or 'builder'
 */
function showDeIdScreen(rawText, fileName, onComplete, returnTo) {
  _deIdRawText    = rawText;
  _deIdFileName   = fileName;
  _deIdOnComplete = onComplete;
  _deIdReturnTo   = returnTo || 'welcome';
...
/**
 * Go back from the de-id screen.
 * Returns to welcome screen or builder depending on how de-id was triggered.
 */
